...
/**
 * Counts words cumulatively in UTF8 encoded, '\n' delimited text received from the network every second starting with initial value of word count. Usage:
 * JavaStatefulNetworkWordCount <hostname> <port> <hostname> and <port> describe the TCP server that Spark Streaming would connect to receive data.
 * <p/>
...
public class JavaStatefulNetworkWordCount
{
	...
	public static void main(String[] args)
	{
		...
		JavaPairDStream<String, Integer> stateDstream = wordsDstream.updateStateByKey(updateFunction, new HashPartitioner(ssc.sc().defaultParallelism()),
				initialRDD);
